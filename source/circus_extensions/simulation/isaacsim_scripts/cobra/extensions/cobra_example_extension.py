...
from isaacsim.examples.interactive.user_examples import CobraExample


class CobraExampleExtension(omni.ext.IExt):
    def on_startup(self, ext_id: str):
        self.example_name = "Cobra"
        self.category = "Policy"

        overview = "This Example shows an Cobra snake robot running a terrain policy trained in Isaac Lab"
        overview += "\n\tKeybord Input:"
