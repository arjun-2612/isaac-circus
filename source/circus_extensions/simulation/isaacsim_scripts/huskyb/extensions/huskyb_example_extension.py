...
from isaacsim.examples.interactive.user_examples import HuskyBetaExample


class HuskyBetaExampleExtension(omni.ext.IExt):
    def on_startup(self, ext_id: str):
        self.example_name = "HuskyBeta"
        self.category = "Policy"

        overview = "This Example shows an HuskyBeta quadruped running a terrain policy trained in Isaac Lab"
        overview += "\n\tKeybord Input:"
