...
class HuskyBetaPolicy(PolicyController):
    """The Spot quadruped"""
    ...
    def __init__(
        ...
        """
        run_name = "2025-07-25_14-25-04" # dynamic trotting policy
        # run_name = "2025-08-03_17-11-38" # stand still policy
        self.data_dir = f"/home/arjun/Documents/sslab_isaaclab/source/sslab_extensions/simulation/isaacsim_scripts/huskyb/data/{run_name}"
        ...
        if usd_path == None:
            usd_path = f"{root_folder}/source/sslab_extensions/simulation/models/husky_beta/huskyb/huskyb.usd"

        super().__init__(name, prim_path, root_path, usd_path, position, orientation)

        self.load_policy(
            f"{root_folder}/logs/rsl_rl/husky_beta_rl/{run_name}/exported/policy.pt",
            f"{root_folder}/logs/rsl_rl/husky_beta_rl/{run_name}/params/env.yaml"
        )
    ...
    def _compute_observation(self, command):
        ...
        # Previous Action
        obs[36:48] = self._previous_action[:12]

        self.data_buffers['lin_vel'].append(lin_vel_b.tolist())
    ...
    def forward(self, dt, command):
        ...
        if command[0] == 99.0:  # Save to ZIP file command
            ...
            self.data_buffers['joint_commanded'].append(joint_pos.tolist())
...
class HuskyBetaExample(BaseSample):
    ...
    def setup_scene(self) -> None:
        ...
        self.sim_robot = HuskyBetaPolicy(
            prim_path="/World/HuskyBeta",
            name="HuskyBeta",
