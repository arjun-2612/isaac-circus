...
from isaacsim.examples.interactive.user_examples import HarpyExample


class HarpyExampleExtension(omni.ext.IExt):
    def on_startup(self, ext_id: str):
        self.example_name = "Harpy"
        self.category = "Policy"

        overview = "This Example shows an Harpy quadruped running a terrain policy trained in Isaac Lab"
        overview += "\n\tKeybord Input:"
