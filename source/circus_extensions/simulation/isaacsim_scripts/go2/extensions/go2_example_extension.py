...
from isaacsim.examples.interactive.user_examples import UnitreeGo2Example


class UnitreeGo2ExampleExtension(omni.ext.IExt):
    def on_startup(self, ext_id: str):
        self.example_name = "UnitreeGo2"
        self.category = "Policy"

        overview = "This Example shows an UnitreeGo2 quadruped running a terrain policy trained in Isaac Lab"
        overview += "\n\tKeybord Input:"
