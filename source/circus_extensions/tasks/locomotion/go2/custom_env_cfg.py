...
@configclass
class UnitreeGo2WalkActionsCfg:
...
class UnitreeGo2WalkCommandsCfg:
    ...
    base_velocity = go2_mdp.isaac.UniformVelocityCommandCfg(
        ...
        ranges=go2_mdp.isaac.UniformVelocityCommandCfg.Ranges(
            lin_vel_x=(-2.0, 2.0), lin_vel_y=(-1.5, 1.5), ang_vel_z=(-2.0, 2.0)
        ),
    )


@configclass
class UnitreeGo2WalkObservationsCfg:
...
@configclass
class UnitreeGo2WalkRewardsCfg:
    # -- task
...
@configclass
class UnitreeGo2WalkTerminationsCfg:
...
class UnitreeGo2CustomEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    actions: UnitreeGo2WalkActionsCfg = UnitreeGo2WalkActionsCfg()
    ...
    events: UnitreeGo2WalkEventCfg = UnitreeGo2WalkEventCfg()
