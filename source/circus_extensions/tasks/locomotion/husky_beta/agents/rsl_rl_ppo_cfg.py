...
@configclass
class HuskyBetaRLPPORunnerCfg(RslRlOnPolicyRunnerCfg):
    num_steps_per_env = 24
    max_iterations = 8000
    save_interval = 200
    experiment_name = "husky_beta_rl"
    logger = "wandb"
    wandb_project = "husky_beta_rl_flat"
...
@configclass
class HuskyBetaDTCPPORunnerCfg(RslRlOnPolicyRunnerCfg):
    num_steps_per_env = 24
    max_iterations = 6000
    save_interval = 200
    experiment_name = "husky_beta_rl"
    logger = "wandb"
    wandb_project = "husky_beta_dtc"
    empirical_normalization = False
    store_code_state = False
    policy = RslRlPpoActorCriticCfg(
        class_name="ActorCritic",
...
@configclass
class HuskyBetaFlightPPORunnerCfg(RslRlOnPolicyRunnerCfg):
    num_steps_per_env = 24
    max_iterations = 2000
    save_interval = 200
    experiment_name = "husky_beta_rl"
    logger = "wandb"
    wandb_project = "husky_beta_flight"
    empirical_normalization = False
    store_code_state = False
    policy = RslRlPpoActorCriticCfg(
        class_name="ActorCritic",
