...
import circus_extensions.tasks.manipulation.allegro_hand.mdp as mdp
from circus_extensions.assets.allegro import ALLEGRO_HAND_CFG, ALLEGRO_JOINT_ORDER
...
@configclass
class AllegroCubeReposeSceneCfg(InteractiveSceneCfg):
...
class AllegroCubeEnvCfg(ManagerBasedRLEnvCfg):
    ...
    # Scene settings
    scene: AllegroCubeReposeSceneCfg = AllegroCubeReposeSceneCfg(num_envs=8192, env_spacing=0.6)
    # Simulation settings
