...
ALLEGRO_JOINT_ORDER = [
    ...
    "index_joint_0",   # Base rotation
    "index_joint_1",   # Proximal flexion
    "index_joint_2",   # Middle flexion
    "index_joint_3",   # Distal flexion
    
    # Middle Finger (4 joints)
    "middle_joint_0",  # Base rotation
    "middle_joint_1",  # Proximal flexion
    "middle_joint_2",  # Middle flexion
    "middle_joint_3",  # Distal flexion
    
    # Ring Finger (4 joints)
    "ring_joint_0",    # Base rotation
    "ring_joint_1",    # Proximal flexion
    "ring_joint_2",    # Middle flexion
    "ring_joint_3",    # Distal flexion
    
    # Thumb (4 joints)
    "thumb_joint_0",   # Base rotation
    "thumb_joint_1",   # Proximal flexion
    "thumb_joint_2",   # Middle flexion
    "thumb_joint_3",   # Distal flexion
]
